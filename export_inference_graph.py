...
PIPELINE_CONFIG_PATH = os.path.join(CWD_PATH, os.path.abspath(cfg['PIPELINE_CONFIG_PATH']) )
CHECKPOINT = os.path.join(CWD_PATH, os.path.abspath(cfg['CHECKPOINT']))
GRAPH_DIRECTORY = os.path.join(CWD_PATH, os.path.abspath(cfg['GRAPH_DIRECTORY']))
...
flags.DEFINE_string('pipeline_config_path', PIPELINE_CONFIG_PATH,
                    ...
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', CHECKPOINT,
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', GRAPH_DIRECTORY, 'Path to write outputs.')
